...
EOL;
                ...
                <div class="tab-pane col-lg-12" id="laboral">
                	<div class="row">
                        ...
                        <div class="col-lg-4">
                        	<input type="text" class="form-control" placeholder="sector" name="sector" data-validation="required">
                        </div>
                        <div class="col-lg-4">
...
EOL;
                        ...
                        <div class="col-lg-4">
                        	<input type="text" class="form-control" placeholder="año de ingreso" name="ano_ingreso" data-validation="required">
                        </div>
                        <div class="clearfix"></div>
...
EOL;
    ...
    <script>
		$(document).ready(function(e) {
            $.ajax({   
				type: "GET",
				url: "MuestraRegistro.php?email=<?php echo $_SESSION['email']; ?>",
				dataType: "json",  
