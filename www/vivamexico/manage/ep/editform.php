...
if ($_POST) {
	...
	$query = "update EP
			  ...
			  educacion = ".$_POST['edu'].",
			  programa = ".$_POST['prog'].",
			  inicia = STR_TO_DATE('".$_POST['fecha']."','%Y/%m/%d %H:%i'),
			  pais = ".$_POST['pais'].",
			  email_ep = ".$_POST['epmail'].",
			  email_man = ".$_POST['manmail']."
			  where id = " . $_GET['id'];
...
<html>
	<head>
		<title>Viva Mexico| Edit EP</title>
				...
				<div class="top-nav">
						<ul class="flexy-menu thick orange">
							...
							<li class="active"><a href="../../igip.html">Professional<br>Internships</a>
								...
								<li><a href="https://podio.com/webforms/6367704/496587">Are you interested?</a></li>
								</ul>
							</li>
		...
		<div class="content">
			...
			<div id="form">
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<p>Email (Manager): </p>
					<p><input type="text" name="manmail" /></p>
