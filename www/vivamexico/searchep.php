...
<html>
	<head>
		<title>Viva Mexico| Search EP</title>
	...
	<body>
			...
			<div class="header">
				...
				<div class="top-nav">
						<ul class="flexy-menu thick orange">
							...
							<li <?php if ($_GET['t'] == "Vol") {echo 'class="active"';}?>><a href="GC.html">GCDP EPs</a>
								<ul>
								<li><a href="GC.html">Profiles</a></li>
								<li><a href="searchep.php?t=Vol">EP Search Tool</a></li>
								</ul>
							</li>
							<li <?php if ($_GET['t'] == "Pro") {echo 'class="active"';}?>><a href="GT.html">GIP EPs</a>
								<ul>
		...
		<div class="offers">
			<div class="offers-head">
				<h3>Search EP Tool for <?php if ($_GET['t']=="Vol") {echo "oGCDP";} else {echo "oGIP";} ?></h3>
				<div class="content">
				<div class="epform">
				<form action="eplist.php" method="post">
					<p>EP ID: <input type="text" name="codigo" /></p>
					<p>Name: <input type="text" name="nombre" /></p>
					<?php if ($_GET['t'] == "Pro") { ?>
					<p>Education: <select name="edu">
					...
					<?php } ?>
					<p><?php if ($_GET['t']=="Vol") {echo "Issue";} else {echo "Program";} ?>: <select name="prog">
						<option value="">Select one</option>
					<?php
						if ($_GET['t'] == "Vol")
						{
							echo '<option value="Health">Health</option>';
							echo '<option value="Social Entrepreneurship">Social Entrepreneurship</option>';
							echo '<option value="Education">Education</option>';
							echo '<option value="Environment">Environment</option>';
							echo '<option value="Culture">Culture</option>';
						}
						else
						{
					...
					<p>Start Date: <input id="datepk" type="text" name="fecha"></p>
					<p>Coutry: <select name="pais">
						<option value="">Select one</option>
					...
					<p>Email (EP): <input type="text" name="epmail" /></p>
					<p>Email (Manager): <input type="text" name="manmail" /></p>
					<?php echo '<input type="hidden" name="tipo" value="'.$_GET['t'].'">'; ?>
