...
$query = "select * from Ep where id = " . $_GET['id'];
			...
			<?php
				if ($result) {
					while ($row = mysqli_fetch_assoc($result)) {
						echo '<p><img src="'.$row['img_link'].'" /></p>';
						echo '<p>Name: '.$row['nombre'].'</p>';
						echo '<p>EP id: '.$row['codigo'].'</p>';
						echo '<p>Education: '.$row['educacion'].'</p>';
						echo '<p>Program: '.$row['programa'].'</p>';
						echo '<p>Start Date: '.$row['inicia'].'</p>';
						echo '<p>Country: '.$row['pais'].'</p>';
						echo '<p>Email (EP): '.$row['email_ep'].'</p>';
						echo '<p>Email (Manager): '.$row['email_man'].'</p>';
						echo '<p>Link: '.$row['email_man'].'</p>';
					}
				}
