...
$magic = $_POST['magic'];
if($comite=='Otro')
	$comite = $_POST['otro_comite'];


$insertUsuarios = "INSERT INTO `aiesec_cp_mult`.`usuario` (`id`, `nombre`, `edad`, `foto`, `email`, `comite`, `magic`) VALUES (NULL, '$nombre', '$edad', '$foto', '$email', '$comite', '$magic');";
//echo $insertUsuarios;
...
$insertAwareness = "INSERT INTO `aiesec_cp_mult`.`self_awareness` (`email`, `suenos`, `intereses`, `actividades`) VALUES ('$email', '$suenos', '$intereses', '$actividades' );";
//echo $insertAwareness;
mysql_query($insertAwareness);	
//echo '<br/>';


$insertTimelineBase="INSERT INTO `aiesec_cp_mult`.`timeline` (`email`, `meta`, `3m`, `6m`, `12m`, `24m`, `60m`, `120m`,`tipo`) VALUES ('".$email."', ";
$insertTimeline="";
...
$insertFODA="INSERT INTO `aiesec_cp_mult`.`foda` (`email`, `fortalezas`, `debilidades`, `oportunidades`, `amenazas`) VALUES ('".$email."', '".$fortalezas."', '".$debilidades."', '".$oportunidades."', '".$amenazas."');";
//echo $insertFODA;
