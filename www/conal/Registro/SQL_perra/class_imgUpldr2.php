...
class imgUpldr {
	...
	private $_width = 10000; // Ancho máximo por defecto
	private $_height = 10000; // Alto máximo por defecto
	private $_size = 2000000; // Peso máximo. MAX_FILE_SIZE sobrescribe este valor
	private $_name = "imagen"; // Nombre por defecto 
	private $_dest = "Registro/fotos/";
	private $_img;
	private $_ext;
	private $_r = "";
	# Métodos mágicos #
...
//		session_start();
		$_SESSION['nombrefoto']= date("Ymdhis").".".$this->_ext;
	}
