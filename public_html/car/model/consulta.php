...
function consultaUsuarioComite($usuario, $conexion, $comite){
	$consul="SELECT * FROM `usuario` WHERE  `email` =  '".$usuario."' AND `comite` =  '".$comite."';";
	$res = mysql_query($consul, $conexion) or die(mysql_error());
	//$result =  mysql_fetch_all($res); 
	$result =  mysql_fetch_row($res); 
	if($result==null){
...
function consultaUsuariosComite($conexion, $comite){
	$consul="SELECT `nombre`, `email` FROM `usuario` WHERE `comite` = '".$comite."';";
	$res = mysql_query($consul, $conexion);// or die(mysql_error());
	$result =  mysql_fetch_all($res); 
	//print_r($result);
	if($result==null){
