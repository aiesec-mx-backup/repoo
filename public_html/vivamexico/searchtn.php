...
if ($_POST)
{
	...
	if ($_POST['filter'] == "id")
	{
		$query .= " and lower(codigo) like '%" . $search . "%'";
	}
	else if ($_POST['filter'] == "comite")
	{
		$query .= " and lower(comite) like '%" . $search . "%'";
	}
	else if ($_POST['filter'] == "estado")
	{
		$query .= " and lower(estado) like '%" . $search . "%'";
	}
	else if ($_POST['filter'] == "nombre")
	{
		$query .= " and lower(nombre) like '%" . $search . "%'";
	}
	else
	{
		$query .= " and lower(proyecto) like '%" . $search . "%'";	
	}
...
<html>
	<head>
		<title>Viva Mexico| Search TN</title>
	...
	<body>
				...
				<div class="top-nav">
						<ul class="flexy-menu thick orange">
							...
							<li><a href="igcdp.html">Volunteer<br>Internships</a>
								...
								<li><a href="http://bit.ly/mexicosearchtool" target="_blank">Search TN Tool</a></li>
								<li><a href="interestgcdp.html">Are you interested?</a></li>
								</ul>
							</li>
		...
		<div class="offers">
			<div class="offers-head">
				<h3>Search TN Tool for <?php if ($_GET['t']=="Vol") {echo "iGCDP";} else {echo "iGIP";} ?></h3>
			<div class="content">
				<div class="searchbar">
					<form action="" method="post">
						...
						<select name="filter">
							...
							<option value="id">TN ID</option>
							<option value="comite">LC</option>
							<option value="estado">City</option>
							<option value="nombre">Name</option>
						</select>
						<br><br><input class="btn" type="submit" value="Search">
					<!--
					<br />
					<input type="checkbox" name="imp_orph" id="imp_orph" value="true"> Impacting Orphanages 
					<input type="checkbox" name="shr_lang" id="shr_lang" value="true"> Sharing Languages 
					<input type="checkbox" name="gl_lead_sc" id="gl_lead_sc" value="true"> Global Leadership School 
					<input type="checkbox" name="my_lang_bd" id="my_lang_bd" value="true"> My Language Buddy 
					<input type="checkbox" name="soc_stup" id="soc_stup" value="true"> Social Startup 
					<input type="checkbox" name="it" id="it" value="true"> Information Technologies
					<input type="checkbox" name="bsns" id="bsns" value="true"> Busssiness
					<input type="checkbox" name="eng" id="eng" value="true"> Engeneering
					<input type="checkbox" name="teach" id="teach" value="true"> Teaching
					<input type="checkbox" name="mkt" id="mkt" value="true"> Marketing
					<input type="checkbox" name="undoc" id="undoc" value="true"> Other
					-->
					</form>
				</div>
				<div class="results">
